...
const BlogList = () => {
  ...
  return (
    <div className="bg-white text-black">
      ...
      <button
        onClick={() => setmenu("ALL")}
        className={menu === "ALL" ? "bg-black text-white py-2 px-4 rounded-sm" : ""}
      >
        {" "}
        ALL
      </button>
      <button
        ...
        className={
          menu === "Technology" ? "bg-black text-white py-2 px-4 rounded-sm" : ""
        }
      >
        {" "}
        Technology
      ...
      <button
        ...
        className={
          menu === "Lifestyle" ? "bg-black text-white py-2 px-4 rounded-sm" : ""
        }
      >
        {" "}
        LifeStyle
